...
public class LoginTest {
    ...
    Login instance = new Login();
    assertTrue(instance.loginUser(username, password, storedUsername, storedPassword));
}
    ...
    String storedPassword = "Ch&&sec@ke99!";
    Login instance = new Login();
    assertFalse(instance.loginUser(username, password, storedUsername, storedPassword));
}
    /**
